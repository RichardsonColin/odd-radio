    ...
    return (
      <div className="container masthead-info">
        ...
        <div className="row">
          ...
          <p>Unlike other internet radio aggregators, the selection on oddrad.io is kept intentionally small. With less than 30 stations to pick from, oddrad.io recreates a true radio dial experience online. Hand selected music for your eager ears.</p>
        </div>
      </div>
    )
  }
