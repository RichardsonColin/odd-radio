    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "five columns border-right " + this.props.Style + " " + (this.props.presets.one.name === this.props.stationFeed ? "playing-preset" : ""),
          ...
          _react2.default.createElement(
            "div",
            { className: "five columns border-right " + this.props.Style + " " + (this.props.presets.two.name === this.props.stationFeed ? "playing-preset" : ""),
              onClick: function onClick(e) {
          ...
          _react2.default.createElement(
            "div",
            { className: "five columns border-right " + this.props.Style + " " + (this.props.presets.three.name === this.props.stationFeed ? "playing-preset" : ""),
              onClick: function onClick(e) {
          ...
          _react2.default.createElement(
            "div",
            { className: "five columns border-right " + this.props.Style + " " + (this.props.presets.four.name === this.props.stationFeed ? "playing-preset" : ""),
              onClick: function onClick(e) {
          ...
          _react2.default.createElement(
            "div",
            { className: "five columns " + this.props.Style + " " + (this.props.presets.five.name === this.props.stationFeed ? "playing-preset" : ""),
              onClick: function onClick(e) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Search2.default, { searchUpdate: this.searchUpdate.bind(this), searchFilter: this.state.searchFilter })
        ),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          this.state.width > 768 && _react2.default.createElement(_StationName2.default, { Style: 'audio-player-station-name', StationFeed: this.props.stationFeed.name, findStationExpandInfo: this.props.findStationExpandInfo }),
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(_Presets2.default, { Style: 'audio-player-presets', presets: this.props.presets, title: 'Presets: ', stationFeed: this.props.stationFeed.name,
  ...
  _createClass(StationList, [{
    ...
    value: function render() {
      ...
      var station = this.props.stations.map(function (post, index) {
        ...
        if (_this2.props.SearchFilter !== "") {
          //if the searchFilter is not empty check if it matches any of the stations. If it is not a match return.
          if (post.name.toLowerCase().indexOf(_this2.props.searchFilter.toLowerCase()) === -1 && post.city.toLowerCase().indexOf(_this2.props.searchFilter.toLowerCase()) === -1 && post.description.toLowerCase().indexOf(_this2.props.searchFilter.toLowerCase()) === -1 && post.province.toLowerCase().indexOf(_this2.props.searchFilter.toLowerCase()) === -1) {
            return;
          }
    ...
    value: function render() {
      ...
      if (this.props.expandedName === this.state.details.name && this.state.expandedStation === true) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'container info-expanded' },
            _react2.default.createElement(
              'div',
              { className: 'row border expanded-buttons' },
              _react2.default.createElement('div', { className: 'four columns station-name center' }),
              _react2.default.createElement(
                'div',
                { className: 'four columns station-play-button center' },
              ...
              _react2.default.createElement(
                'div',
                { className: 'four columns station-info-button center' },
            ...
            _react2.default.createElement(
              'div',
              { className: 'row border center-align station-info info' },
              _react2.default.createElement(
                'div',
              ...
              _react2.default.createElement(
                'div',
                { className: 'eight columns station-details' },
                _react2.default.createElement(
                  'div',
            ...
            _react2.default.createElement(
              'div',
              { className: 'row border center-align' },
              _react2.default.createElement(
                'div',
                { className: 'column' },
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'four columns station-branding center' },
  ...
  _createClass(SetPresets, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "center row presets-title" },
          this.props.title
        ),
        _react2.default.createElement(
          "div",
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "p",
            null,
            "Unlike other internet radio aggregators, the selection on oddrad.io is kept intentionally small. With less than 30 stations to pick from, oddrad.io recreates a true radio dial experience online. Hand selected music for your eager ears."
          )
        )
      );
    }
...
var Search = function (_Component) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "search-container u-full-width" },
        _react2.default.createElement(
          "form",
          { className: "search-form u-full-width" },
          _react2.default.createElement("input", { className: "search-input", type: "text", ref: function ref(value) {
              return _this2.searchValue = value;
            }, placeholder: "Search", onChange: this.searchParams.bind(this) })
        )
      );
    }
  }]);
